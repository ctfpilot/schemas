...
CTF Pilot utilizes various schemas to define the structure and format of different components within the platform. These schemas ensure consistency and facilitate automation across the system.
